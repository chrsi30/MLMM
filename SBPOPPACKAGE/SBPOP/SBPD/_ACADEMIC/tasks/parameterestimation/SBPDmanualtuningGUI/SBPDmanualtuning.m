...
if ~isnan(handles.boundsaxis),
    ...
    feval(handles.dataPlotType,sim_timevector,sim_componentvalues,'linewidth',2); hold on;
...
if ~isnan(handles.boundsaxis),
    [meas_timevector,meas_componentvalues] = stripSmallerTimes(meas_timevector,meas_componentvalues,handles.boundsaxis(1));   
        ...
        feval(handles.dataPlotType,meas_timevector,meas_componentvalues,'*','linewidth',2); hold on;
