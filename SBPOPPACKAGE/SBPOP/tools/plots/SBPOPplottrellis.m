...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% If NaN in nameX then remove, same for nameY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for k=1:length(allGROUP),
    ...
    if ylabelfirstonly && plotSubplot==1 && nrows > 1,
        ylabel(ylabelText,'FontUnits','points','FontSize',labeltextsize,'HorizontalAlignment','Right');
    elseif nrows == 1,
        if plotSubplot==1,
            ylabel(ylabelText,'FontUnits','points','FontSize',labeltextsize);     
        end
