...
for k=1:length(allGROUP),
    ...
    if plotFigure < nFigures,
        ...
        if plotSubplot > nSubplots-ncols,
            xlabel(xlabelText,'FontUnits','points','FontSize',labeltextsize);
        end
    else
    ...
    ylabel(ylabelText{k},'FontUnits','points','FontSize',labeltextsize);
    ...
    if showslope1line,
        ...
        plot([min(XLim(1),YLim(1)) min(max(XLim(2),maxY),maxY)], [min(XLim(1),YLim(1)) min(max(XLim(2),maxY),maxY)],slope1linestyle,'Color',slope1linecolor);
    end
    ...
    if showzeroLines,
        ...
        plot([0 0],[minY maxY],zeroLinesstyle,'Color',zeroLinescolor)
        plot(XLim,[0 0],zeroLinesstyle,'Color',zeroLinescolor)
    end
