...
% Other options
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
titlefontsize     = min(heighttitlebarX,widthtitlebarY)-0.02;
...
titlefontsize     = heighttitlebarX-0.02;
...
for kSubplot=1:nSubplots,
    ...
    if kSubplot<=ncols,
        ...
        if length(allGroupX)==1,
            text(X,Y,'All Data','FontWeight','bold','FontUnits','normalized','FontSize',titlefontsize,'HorizontalAlignment','Center');
        else
            text(X,Y,sprintf('%s=%g',nameGroupX,allGroupX(kSubplot)),'FontWeight','bold','FontUnits','normalized','FontSize',titlefontsize,'HorizontalAlignment','Center');
        end
    end
    ...
    if  mod(kSubplot-1,ncols)+1==ncols,
        ...
        if length(allGroupY)==1,
            h = text(X,Y,'All Data','FontWeight','bold','FontUnits','normalized','FontSize',titlefontsize,'HorizontalAlignment','Center','Rotation',270);
        else
            h = text(X,Y,sprintf('%s=%g',nameGroupY,allGroupY(ceil(kSubplot/ncols))),'FontWeight','bold','FontUnits','normalized','FontSize',titlefontsize,'HorizontalAlignment','Center','Rotation',270);
        end
    end
