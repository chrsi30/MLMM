function [] = vpcMedianSampledParamSBPOP(projectfolder,NSAMPLES)
% Do VPC based on sampled parameters from the uncertainty distribution. Use
% transformed parameters to determine the distribution to sample from.
