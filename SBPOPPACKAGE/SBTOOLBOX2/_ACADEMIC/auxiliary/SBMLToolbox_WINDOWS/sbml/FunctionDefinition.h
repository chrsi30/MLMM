 ...
 *
 * $Id: FunctionDefinition.h,v 1.34 2007/11/28 05:26:58 mhucka Exp $
 * $Source: /cvsroot/sbml/libsbml/src/sbml/FunctionDefinition.h,v $
 *
 *<!---------------------------------------------------------------------------
...
public:
   ...
   * 
   * @return the #SBMLTypeCode_t value of SBML objects contained in this ListOf or
